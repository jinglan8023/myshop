<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"/data/wwwroot/default/myshop/public/../application/index/view/login/login.html";i:1547727029;}*/ ?>
<!DOCTYPE html>
<html>
				...
				$.post(
					...
					function(msg){
				        ...
				        if(msg.code==1){
							...
							if(refer){
								window.location.href=refer+'?goods_id='+goods_id;
