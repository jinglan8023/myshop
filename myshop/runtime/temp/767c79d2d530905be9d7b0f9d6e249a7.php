...
<div class="i_bg bg_color">
        ...
        <div class="banner">
            <div class="top_slide_wrap">
                <ul class="slide_box bxslider">
                    <li><img src="__STATIC__/index/images/a1.jpg" width="740" height="401" /></li>
                    <li><img src="__STATIC__/index/images/a2.jpg" width="740" height="401" /></li>
                    <li><img src="__STATIC__/index/images/a3.jpg" width="740" height="401" /></li>
                </ul>
    ...
    <!--Begin 进口 生鲜 Begin-->
    <div cate_id="<?php echo $info['oneData']['cate_id']; ?>" floor_num="1">
        <div class="i_t mar_10">
            <span class="floor_num">1F</span>
            <span class="fl"><?php echo $info['oneData']['cate_name']; ?></span>
            <span class="i_mores fr">
                <?php if(is_array($info['twoData']) || $info['twoData'] instanceof \think\Collection || $info['twoData'] instanceof \think\Paginator): $i = 0; $__LIST__ = $info['twoData'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
            ...
            <div class="fresh_mid">
                <ul>
                    <?php if(is_array($info['goodsData']) || $info['goodsData'] instanceof \think\Collection || $info['goodsData'] instanceof \think\Paginator): $i = 0; $__LIST__ = $info['goodsData'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                        <li>
                            <div class="name">
                                <a href="<?php echo url('product/productdetail',['goods_id'=>$v['goods_id'],'type_id'=>$v['type_id']]); ?>"><?php echo $v['goods_name']; ?></a>
                            </div>
                            <div class="price">
                            ...
                            <div class="img">
                                <a href="<?php echo url('product/productdetail',['goods_id'=>$v['goods_id'],'type_id'=>$v['type_id']]); ?>">
                                    <img src="__ROOT__/uploads/goodsimg/<?php echo $v['goods_img']; ?>" width="185" height="155" />
                                </a>
                            </div>
                        </li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <a href="javascript:;" id="moveFloor" style="margin-left: 100px;">加载更多</a>
    <!--End 进口 生鲜 End-->
