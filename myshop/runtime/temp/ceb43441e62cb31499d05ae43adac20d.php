    ...
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="WEB_NAME" required  lay-verify="required" value="<?php echo !empty($info['WEB_NAME'])?$info['WEB_NAME']:''; ?>" autocomplete="off" class="layui-input">
            </div>
        </div>
        <!--管理员账号-->
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="WEB_URL" required  lay-verify="required|url" value="<?php echo !empty($info['WEB_URL'])?$info['WEB_URL']:''; ?>" autocomplete="off" class="layui-input">
            </div>
        </div><!--管理员账号-->
        <div class="layui-form-item">
            <label class="layui-form-label">版权</label>
            <div class="layui-input-block">
                <input type="text" name="WEB_COPYRIGHT" required  lay-verify="required" value="<?php echo !empty($info['WEB_COPYRIGHT'])?$info['WEB_COPYRIGHT']:''; ?>" autocomplete="off" class="layui-input">
            </div>
        </div><!--管理员账号-->
        <div class="layui-form-item">
            <label class="layui-form-label">版本号</label>
            <div class="layui-input-block">
                <input type="text" name="WEB_RECORD" required  lay-verify="required" value="<?php echo !empty($info['WEB_RECORD'])?$info['WEB_RECORD']:''; ?>" autocomplete="off" class="layui-input">
            </div>
        </div>
            ...
            form.on('submit(*)',function(data){
                ...
                $.post(
                        ...
                        function(result){
                            ...
                            if(result.code==1){
                                setTimeout(function(){
                                    location.href="<?php echo url('system/system'); ?>"},2000);
                            }
                        },
                        'json'
                );
