<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"/data/wwwroot/default/myshop/public/../application/admin/view/login/login.html";i:1543383419;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="logo_box">
                ...
                <form  method="post"  class="layui-form">
                    <div class="input_outer">
                        ...
                        <input  name="admin_name" class="text"  style="color: #000000 !important" type="text" placeholder="请输入账户" lay-verify="required">
                    </div>
                    <div class="input_outer">
                        <span class="us_uer"></span>
                        <input  name="admin_pwd" class="text"  style="color: #000000 !important; position:absolute; z-index:100;"value="" type="password" placeholder="请输入密码" lay-verify="required">
                    </div>
                    <div>
                        <input type="text" name="mycode" style="width: 120px;height: 50px;border-radius: 25px;border: 1px solid #ccc;" lay-verify="required">
            ...
            form.on('submit(sub)',function(data){
                $.post(
                        ...
                        function(res){
                            ...
                            if(res.code==1){
                                setTimeout(function(){
                                    location.href="<?php echo url('Index/index'); ?>"},2000);
                            }
                        },
                        'json'
                )
